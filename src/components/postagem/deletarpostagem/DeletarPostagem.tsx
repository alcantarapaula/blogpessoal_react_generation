...
function DeletarPostagem() {
    ...
    useEffect(() => {
        if (token === '') {
            ToastAlerta('Você precisa estar logado para realizar esta ação', 'info')
            navigate('/')
        }
    }, [token])
  ...
  return (
    <div className="container w-1/3 mx-auto">
      ...
      <p className="text-center font-semibold mb-4">Você tem certeza de que deseja apagar a seguinte postagem?</p>
